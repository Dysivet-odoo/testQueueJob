    ...
    def _eval_context_telegram(self, secrets, eval_context):
        ...
        * multi_livechat.*
        ...
        def _html_sanitize_telegram(html):
            # delete_my_code
            print("- sync_project  _html_sanitize_telegram")
            print(html)
        ...
        def create_mail_сhannel(partners, channel_name):
            # delete_my_code
            print("- sync_project  create_mail_сhannel")
            print(channel_name)
            print(partners)
            vals = self.env["mail.channel"].with_context()._prepare_multi_livechat_channel_vals(
        ...
        def sendMessage(chat_id, html, *args, **kwargs):
            # delete_my_code
            print("- sync_project  sendMessage")
        ...
        def sendDocument(chat_id, name, datas, *args, **kwargs):
            # delete_my_code
            print("- sync_project  sendDocument")
            channel = kwargs.pop("channel", None)
            try:
                bot.send_document(
